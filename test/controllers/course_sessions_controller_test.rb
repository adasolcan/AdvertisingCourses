...
class CourseSessionsControllerTest < ActionController::TestCase
  ...
  test "should create course_session" do
    assert_difference('CourseSession.count') do
      post :create, course_session: { course_id: @course_session.course_id, date_time: @course_session.date_time, instructor_id: @course_session.instructor_id, place: @course_session.place }
    end
  ...
  test "should update course_session" do
    patch :update, id: @course_session, course_session: { course_id: @course_session.course_id, date_time: @course_session.date_time, instructor_id: @course_session.instructor_id, place: @course_session.place }
    assert_redirected_to course_session_path(assigns(:course_session))
  end
